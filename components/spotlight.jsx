"use client";
import "@/app/style/spotlight.css";
const pi1 = "/assets/img/pi1.webp";
const pi2 = "/assets/img/pi2.webp";
const pi3 = "/assets/img/pi3.webp";
import { useEffect, useRef } from "react";
const Spot = "/assets/img/pi3.webp"
...
const spotlightItems = [
  { name: "Courtyard Stillness", img: pi1 },
  { name: "Blue Horizon", img: pi2 },
  { name: "Stone Quiet", img: pi3 },
  { name: "Amber Niche", img: pi1 },
  { name: "Earthen Shelf", img: pi2 },
  { name: "Reflective White", img: pi3 },
  { name: "Desert Edge", img: pi1 },
  { name: "Soft Passage", img: pi2 },
  { name: "Water Column", img: pi3 },
  { name: "Golden Retreat", img: pi1 },
];
