...
const Cardcon1 = "/assets/img/webdev1.png"
const Cardcon2 = "/assets/img/webdev2.png"
const Cardcon3 = "/assets/img/webdev3.png"
const Cardcon4 = "/assets/img/webdev4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/webapp'><button className="back-button">
            Next Service <ArrowRight size={16} />
          </button></Link>
        </div>
        <div className="sh-top uiux-hero">
          <img src={Circleblur} alt="" />
          <h1 className="slideinLoad">Website Development</h1>
        </div>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Website" />
      </div>
