...
const Cardcon2 = "/assets/img/appdev2.png"
const Cardcon3 = "/assets/img/appdev3.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/intaweb'><button className="back-button">
        ...
        <p className="ui-hero-p scrollReveal">From idea to app store, we deliver powerful mobile applications with sleek performance, robust backend, and cross-platform reach.</p>
        ...
        <div className="provide-grid">
          ...
          <div className="provide-card p-sec2-card2">
            <div className="p-top-card">
              <img src={CardImg} alt="" />
              <div className="top-card-con">
                <img className="ui4" src={Cardcon2} alt="" />
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Application" />
      </div>
