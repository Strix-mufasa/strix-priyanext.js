...
const Cardcon1 = "/assets/img/intaweb1.png"
const Cardcon2 = "/assets/img/intaweb2.png"
const Cardcon3 = "/assets/img/intaweb3.png"
const Cardcon4 = "/assets/img/intaweb4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/ecommerce'><button className="back-button">
        ...
        <p className="ui-hero-p scrollReveal">We build conversion - optimized landing pages that drive sign-ups, leads, and sales - engineered for speed and performance.</p>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Landing page" />
      </div>
