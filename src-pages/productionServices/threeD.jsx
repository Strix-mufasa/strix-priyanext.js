...
const Cardcon1 = "/assets/img/3d1.png"
const Cardcon2 = "/assets/img/3d2.png"
const Cardcon3 = "/assets/img/3d3.png"
const Cardcon4 = "/assets/img/3d4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/commercials'><button className="back-button">
            Next Service <ArrowRight size={16} />
          </button></Link>
        </div>
        <div className="sh-top uiux-hero">
          <img src={Circleblur} alt="" />
          <h1 className="slideinLoad">3D Animations</h1>
        </div>
        ...
        <p className="ui-hero-p scrollReveal">We develop websites that blend speed, security, and scalability - built with clean code and optimized for long-term growth.</p>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="3D"/>
      </div>
