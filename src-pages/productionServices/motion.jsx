...
const Cardcon1 = "/assets/img/motion1.png"
const Cardcon2 = "/assets/img/motion2.png"
const Cardcon3 = "/assets/img/motion3.png"
const Cardcon4 = "/assets/img/motion4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/threed'><button className="back-button">
            Next Service <ArrowRight size={16} />
          </button></Link>
        </div>
        <div className="sh-top uiux-hero">
          <img src={Circleblur} alt="" />
          <h1 className="slideinLoad">Motion Graphics</h1>
        </div>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Motion Graphics"/>
      </div>
