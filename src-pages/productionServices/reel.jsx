...
const Cardcon1 = "/assets/img/reel1.png"
const Cardcon2 = "/assets/img/reel2.png"
const Cardcon3 = "/assets/img/reel3.png"
const Cardcon4 = "/assets/img/reel4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/motion'><button className="back-button">
        ...
        <p className="ui-hero-p scrollReveal">We create engaging reels and short-form content that’s designed to grab attention and perform on social platforms.</p>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Reels/shorts"/>
      </div>
