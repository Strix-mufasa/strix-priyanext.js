...
const Cardcon1 = "/assets/img/ui1.png"
const Cardcon2 = "/assets/img/ui2.png"
const Cardcon3 = "/assets/img/ui3.png"
const Cardcon4 = "/assets/img/ui4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/webdesign'><button className="back-button">
        ...
        <div className="provide-grid">
          <div className="provide-card p-sec2-card1">
            <div className="p-top-card">
              ...
              <div className="top-card-con">
                <img className="ui1" src={Cardcon1} alt="SaaS Interfaces" />
                <p>SaaS Interfaces</p>
              </div>
            </div>
          ...
          <div className="provide-card p-sec2-card1">
            <div className="p-top-card">
              <img src={CardImg} alt="" />
              <div className="top-card-con">
                <img className="ui1" src={Cardcon3} alt="Enterprise Applications" />
          ...
          <div className="provide-card p-sec2-card2">
            <div className="p-top-card">
              <img src={CardImg} alt="" />
              <div className="top-card-con">
                <img className="ui1" src={Cardcon4} alt="User Flows & Wireframes" />
