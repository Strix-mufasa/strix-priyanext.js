...
const Cardcon1 = "/assets/img/brand1.png"
const Cardcon2 = "/assets/img/brand2.png"
const Cardcon3 = "/assets/img/brand3.png"
const Cardcon4 = "/assets/img/brand4.png"
    ...
    <div>
      ...
      <div className="service-hero">
        <div className="returnNext" >
          ...
          <Link href='/uiux'><button className="back-button">
            Next Service <ArrowRight size={16} />
          </button></Link>
        </div>
        <div className="sh-top uiux-hero">
          <img src={Circleblur} alt="" />
          <h1 className="slideinLoad">Branding</h1>
        </div>
      ...
      <div className='project-carousel-con'>
        ...
        <ProjectCarousel serviceFilter="Branding" />
      </div>
