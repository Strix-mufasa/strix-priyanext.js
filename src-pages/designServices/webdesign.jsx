...
const Cardcon1 = "/assets/img/wdesign1.png"
const Cardcon2 = "/assets/img/wdesign2.png"
const Cardcon3 = "/assets/img/wdesign3.png"
const Cardcon4 = "/assets/img/wdesign4.png"
        ...
        <div>
            ...
            <div className="service-hero">
                <div className="returnNext" >
                    ...
                    <Link href='/appdesign'><button className="back-button">
                ...
                <div className="sh-top uiux-hero">
                    ...
                    <h1 className="slideinLoad">Website Designs</h1>
                </div>
                ...
                <p className="ui-hero-p scrollReveal">We create stunning websites that are not just beautiful, but smart — blending user-first navigation, modern UI/UX, and conversion-ready architecture.</p>
                    ...
                    <div className="provide-card p-sec2-card1">
                        <div className="p-top-card">
                            ...
                            <div className="top-card-con">
                                <img className="ui1" src={Cardcon1} alt="" />
                                <p>E-commerce/Product Store</p>
                            </div>
                        </div>
                    ...
                    <div className="provide-card p-sec2-card1">
                        <div className="p-top-card">
                            ...
                            <div className="top-card-con">
                                ...
                                <p>E-Commerce/Newsletter Designs</p>
                            </div>
                        </div>
                        <p className="provide-card-p">At Strix Productions, we design, develop, and deliver world-class visuals and experience</p>
                        <BtnNormsall text="Get a quote" to="/contact" />
                    ...
                    <div className="provide-card p-sec2-card2">
                        <div className="p-top-card">
                            ...
                            <div className="top-card-con">
                                ...
                                <p>Simple UI Interactive Designs</p>
                            </div>
                        </div>
                        <p className="provide-card-p">At Strix Productions, we design, develop, and deliver world-class visuals and experience</p>
                        <BtnNormsall text="Get a quote" to="/contact" />
            ...
            <div className='project-carousel-con'>
                ...
                <ProjectCarousel serviceFilter="Web Design" />
            </div>
